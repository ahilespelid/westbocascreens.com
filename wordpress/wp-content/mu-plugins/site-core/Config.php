...
final class Config
{
     ...
     *
     * autoplay включён: как и VIDEO_SCREENS в середине страницы, этот ролик запускается
     * сам, когда посетитель до него доскроллил. Одновременно играет только один ролик
     * на странице — video.js ставит остальные на паузу, подробнее у Blocks::renderVideo().
     *
     ...
     *
     * autoplay включён: см. VIDEO_VILLA выше про то, как несколько таких роликов
