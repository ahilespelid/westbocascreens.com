...
final class Layout
{
    ...
    /**
     * Подвал: врезка с оффером для частных домовладельцев, карта зоны обслуживания,
     * статус компании, ZIP-коды и кредит разработчика.
     *
     * @return void
     */
    public static function renderFooter(): void
    {
        // Врезка про частные дома — на всех страницах, кроме коммерческой: у неё свой оффер,
        // и предлагать бесплатный замер патио посетителю B2B-страницы не по адресу.
        if (!is_page('commercial-custom-shade-solutions')) {
            Blocks::renderResidentialTeaser();
        }
        ?>
        <div class="sc-footer">
